...
static const Key keys[] = {
    ...
    { MODKEY,			               XK_c,            spawn,                 SHCMD(TERMINAL " -e profanity") },
	{ MODKEY,			               XK_n,            spawn,                 SHCMD(TERMINAL " -e nvim -c VimwikiIndex") },
	{ MODKEY|ShiftMask,	               XK_n,            spawn,                 SHCMD(TERMINAL " -e newsboat ; pkill -RTMIN+6 dwmblocks") },
	{ MODKEY,			               XK_m,            spawn,                 SHCMD(TERMINAL " -e ncmpcpp") },
    { MODKEY,			               XK_Insert,       spawn,                 SHCMD("xdotool type $(grep -v ^# ~/.local/share/larbs/snippets | dmenu -i -l 30 -p Bookmarks: )") },

	{ MODKEY,			                XK_F1,         spawn,                  SHCMD("otp") },
	{ MODKEY,			                XK_F2,         spawn,                  SHCMD("ytfzf -D") },	
    ...
    { MODKEY,			                XK_F11,        spawn,                  SHCMD("linkhandler") },
